      ...
      <nav className="fixed top-0 w-full bg-gray-900/95 backdrop-blur-md z-50 border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-orange-500 whitespace-nowrap">
              {language === 'en' ? "Sahle Shiro Bet" : "ሳህሌ ሽሮ ቤት"}
            </h1>
          </div>

          <div className="hidden md:flex gap-8 text-base">
            <a href="#home" className="hover:text-orange-500">{t('Home', 'መነሻ')}</a>
            <a href="#menu" className="hover:text-orange-500">{t('Menu', 'ምግብ')}</a>
            <a href="#contact" className="hover:text-orange-500">{t('Contact', 'ያግኙን')}</a>
          </div>
          ...
          <div id="food-carousel" className="flex gap-4 md:gap-6 overflow-x-auto scrollbar-hide py-4">
            {menuItems.slice(0, 8).map(item => (
              ...
              >
                ...
                <div className="p-4">
                  <h4 className="font-bold text-base sm:text-lg text-green-400">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 sm:gap-6">
            {filteredItems.map(item => (
              ...
              >
                ...
                <div className="p-5">
                  <h4 className="font-bold text-base sm:text-lg text-green-400 leading-tight">
                    {language === 'en' ? item.name : item.nameAm}
                  </h4>
      ...
      <footer id="contact" className="bg-black py-12 md:py-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-400">
            {language === 'en' 
              ? "Ayer Tena, Addis Ababa • Daily 1:00 AM - 10:00 PM" 
              : "አየር ጠና፣ አዲስ አበባ • ዕለት ሁሉ 1፡00 ጥዋት - 10፡00 ማታ"}
          </p>
        </div>
      </footer>
        ...
        <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-900 rounded-3xl max-w-md w-full overflow-hidden relative">
            <button
              ...
              className="absolute top-4 right-4 z-10 bg-black/80 hover:bg-black text-white w-10 h-10 rounded-full flex items-center justify-center text-2xl transition"
            >
              ✕
            </button>
            ...
            <div className="p-6 sm:p-8">
              ...
              <p className="text-3xl sm:text-4xl font-bold text-orange-400 mt-2">ETB {selectedItem.price}</p>
